...
We first of all consider Regularized Discriminant Analysis. Applying it, we reached the conclusion that we should directly use LDA, as $\lambda=1$ and $\gamma$ is very close to zero.\\
