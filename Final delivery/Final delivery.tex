...
We have resampled our data in the following way: we have a \textbf{training set}, which has $\frac{2}{3}$ of randomly chosen samples from the whole data set, and a \textbf{testing set}, which has the remaining $\frac{1}{3}$.
