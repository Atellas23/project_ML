...
```{r}
# 1. trobar centres, nombre de neurones i variàncies
# 2. entrenar els pesos amb un LM (amb regularització)
# 3. interpretar la predicció com la probabilitat de pertanyer a la classe 1 (sigui aquesta w o r)
```
